    ...
    return (
        <div className='p-2 md:p-4'>
            <div className='w-full max-w-4xl m-auto md:flex bg-white '>
                <div className='max-w-sm overflow-hidden cent w-full p-7'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <div className='flex gap-3'>
                        <button className='bg-yellow-500 py-1 my-2 mt-2 rounded hover:bg-yellow-600 min-w-[100px]'>Buy</button>
                        <button onClick={handleAddCartProduct} className='bg-yellow-500 py-1 my-2 mt-2 rounded hover:bg-yellow-600 min-w-[100px]'>Add Cart</button>
                    </div>
                    <div className=''>
